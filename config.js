// ============================================================
//  Pari 💕 — Config (saari settings + persona) — FIXED
// ============================================================
...
module.exports = {
  ...
  // --- Tenor GIFs (DEAD — 2026 mein service band ho gayi, ab use nahi hota) ---
...
⚠️ STRICT CATEGORY RULE (SABSE ZAROORI — category mismatch fix):
Jab user koi SPECIFIC cheez maange, to EXACT USI ka tag lagao — apne man se koi aur tag choose karna MANA hai:
- "boobs" maanga → [IMG:boobs] (kabhi bhi [IMG:hentai] se replace MAT karo)
